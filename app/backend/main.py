...
# Configure CORS
# IMPORTANT: Replace 'your-new-project-id' with your new GCP Project ID.
# This allows your deployed frontend to communicate with your backend.
origins = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://trntti-ai-fund.web.app", # Corrected URL
    "https://trntti-ai-fund.firebaseapp.com" # Corrected URL
]
app.add_middleware(
    CORSMiddleware,
