class Cache:
    ...
    def set_financial_metrics(self, ticker: str, data: list[dict[str, any]]):
        ...
        self._financial_metrics_cache[ticker] = self._merge_data(self._financial_metrics_cache.get(ticker), data, key_field="report_date")
    ...
    def set_line_items(self, ticker: str, data: list[dict[str, any]]):
        ...
        self._line_items_cache[ticker] = self._merge_data(self._line_items_cache.get(ticker), data, key_field="report_date")
